...
{
    private $data1 = "Rome:Jan 81.2,Feb 63.2,Mar 70.3,Apr 55.7,May 53.0,Jun 36.4,Jul 17.5,Aug 27.5,Sep 60.9,Oct 117.7,Nov 111.0,Dec 97.9\n"
    ...
    /**@test */
    public function test_rainfall_basics()
    {
        $this->assertEquals(51.199999999999996, Rainfall::mean("London", $this->data1));
        $this->assertEquals(52.416666666666664, Rainfall::mean("Beijing", $this->data1));

        $this->assertEquals(57.42833333333374, Rainfall::variance("London", $this->data1));
        $this->assertEquals(4808.37138888889, Rainfall::variance("Beijing", $this->data1));

        $this->assertEquals(57.03333333333333, Rainfall::mean("London", $this->data2));
        $this->assertEquals(59.083333333333336, Rainfall::mean("Beijing", $this->data2));

        $this->assertEquals(110.90055555555546, Rainfall::variance("London", $this->data2));
        $this->assertEquals(4437.038055555556, Rainfall::variance("Beijing", $this->data2));
    }
}
